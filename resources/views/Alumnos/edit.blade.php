...
<body class="container mt-5">
    ...
    <div class="mb-3">
        ...
        <input type="text" name="name" class="form-control" id="name" value="{{ old('name', $alumno->name) }}" required>
    </div>
    <div class="mb-3">
        <label for="apellido" class="form-label">Apellido Alumno</label>
        <input type="text" name="apellido" class="form-control" id="apellido" value="{{ old('apellido', $alumno->apeliido) }}" required>
    </div>
    <div class="mb-3">
